...
struct filetype DS18S20[] = {
	F_STANDARD,
  {"temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_10temp}, {o: NULL}, {v:NULL},},
  ...
  {"die", 2, NULL, ft_ascii, fc_static, {o: FS_r_die}, {o: NULL}, {i:1},},
  {"trimvalid",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_r_trimvalid}, {o: NULL}, {v:NULL},},
...
struct filetype DS18B20[] = {
	F_STANDARD,
//    {"scratchpad",     8,  NULL, ft_binary, fc_volatile, {o: FS_tempdata}   ,{o: NULL}, NULL, } ,
  {"temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {o: NULL}, {i:12},},
  {"temperature9",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {o: NULL}, {i:9},},
  {"temperature10",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {o: NULL}, {i:10},},
  {"temperature11",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {o: NULL}, {i:11},},
  {"temperature12",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {o: NULL}, {i:12},},
  {"fasttemp",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {o: NULL}, {i:9},},
  {"templow",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:1},},
  {"temphigh",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:0},},
  {"trim",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_trim}, {o: FS_w_trim}, {v:NULL},},
  {"die", 2, NULL, ft_ascii, fc_static, {o: FS_r_die}, {o: NULL}, {i:2},},
  {"trimvalid",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_r_trimvalid}, {o: NULL}, {v:NULL},},
  {"trimblanket",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_r_blanket}, {o: FS_w_blanket}, {v:NULL},},
  {"power",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_power}, {o: NULL}, {v:NULL},},
};
...
//    {"scratchpad",     8,  NULL, ft_binary, fc_volatile, {o: FS_tempdata}   ,{o: NULL}, NULL, } ,
  ...
  {"temphigh",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:0},},
  {"trim",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_trim}, {o: FS_w_trim}, {v:NULL},},
  {"die", 2, NULL, ft_ascii, fc_static, {o: FS_r_die}, {o: NULL}, {i:0},},
  {"trimvalid",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_r_trimvalid}, {o: NULL}, {v:NULL},},
  {"trimblanket",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_r_blanket}, {o: FS_w_blanket}, {v:NULL},},
  {"power",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_power}, {o: NULL}, {v:NULL},},
};
...
//    {"scratchpad",     8,  NULL, ft_binary, fc_volatile, {o: FS_tempdata}   ,{o: NULL}, NULL, } ,
  ...
  {"temphigh",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:0},},
  {"power",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_power}, {o: NULL}, {v:NULL},},
  {"prog_addr",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_r_ad}, {o: NULL}, {v:NULL},},
};
...
//    {"scratchpad",     8,  NULL, ft_binary, fc_volatile, {o: FS_tempdata}   ,{o: NULL}, NULL, } ,
  ...
  {"sensed",PROPERTY_LENGTH_BITFIELD, &A28EA00, ft_bitfield, fc_volatile, {o: FS_sense}, {o: NULL}, {v:NULL},},
};
