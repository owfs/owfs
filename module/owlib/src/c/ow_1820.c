...
struct filetype DS18S20[] = {
	F_STANDARD,
	{"temperature", PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_simultaneous_temperature, FS_10temp, NO_WRITE_FUNCTION, {v:NULL},},
...
//    {"scratchpad",     8,  NULL, ft_binary, fc_volatile,   FS_tempdata, NO_WRITE_FUNCTION, NULL, } ,//    {"scratchpad",     8,  NULL, ft_binary, fc_volatile,  {o:FS_tempdata} ,
	{"temperature", PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_link, FS_slowtemp, NO_WRITE_FUNCTION, {i:12},},
	{"temperature9", PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_simultaneous_temperature, FS_22temp, NO_WRITE_FUNCTION, {i:9},},
	{"temperature10", PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_simultaneous_temperature, FS_22temp, NO_WRITE_FUNCTION, {i:10},},
	{"temperature11", PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_simultaneous_temperature, FS_22temp, NO_WRITE_FUNCTION, {i:11},},
	{"temperature12", PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_simultaneous_temperature, FS_22temp, NO_WRITE_FUNCTION, {i:12},},
