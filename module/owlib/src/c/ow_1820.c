...
struct filetype DS18S20[] = {
	F_STANDARD,
  {"temperature", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_volatile, {o: FS_10temp}, {v: NULL}, {v:NULL},},
  {"templow", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:1},},
  {"temphigh", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:0},},
...
//    {"scratchpad",     8,  NULL, ft_binary, fc_volatile, FS_tempdata   , NULL, NULL, NULL,} ,
  {"temperature", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {v: NULL}, {i:12},},
  {"temperature9", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {v: NULL}, {i:9},},
  {"temperature10", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {v: NULL}, {i:10},},
  {"temperature11", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {v: NULL}, {i:11},},
  {"temperature12", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {v: NULL}, {i:12},},
  {"fasttemp", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_volatile, {o: FS_22temp}, {v: NULL}, {i:9},},
  {"templow", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:1},},
  {"temphigh", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:0},},
  {"trim", PROPERTY_LENGTH_FLOAT, NULL, ft_unsigned, fc_volatile, {o: FS_r_trim}, {o: FS_w_trim}, {v:NULL},},
...
//    {"scratchpad",     8,  NULL, ft_binary, fc_volatile, FS_tempdata   , NULL, NULL, } ,
  ...
  {"temphigh", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_stable, {o: FS_r_templimit}, {o: FS_w_templimit}, {i:0},},
  {"power", PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_power}, {v: NULL}, {v:NULL},},
  {"PIO", PROPERTY_LENGTH_UNSIGNED, &A28EA00, ft_bitfield, fc_stable, {o: FS_r_pio}, {o: FS_w_pio}, {v:NULL},},
  {"sensed", PROPERTY_LENGTH_UNSIGNED, &A28EA00, ft_bitfield, fc_volatile, {o: FS_sense}, {v: NULL}, {v:NULL},},
};
