...
struct filetype DS2406[] = {
	F_STANDARD,
  {"memory", 128, NULL, ft_binary, fc_stable,  {o:FS_r_mem}, {o:FS_w_mem}, {v:NULL},},  {"memory", 128, NULL, ft_binary, fc_stable,  {o:FS_r_mem}, {o:FS_w_mem}, {v:NULL},},  {"memory", 128, NULL, ft_binary, fc_stable,  {o:FS_r_mem}, {o:FS_w_mem}, {v:NULL},},  {"memory", 128, NULL, ft_binary, fc_stable, {o: FS_r_mem}, {o: FS_w_mem}, {v:NULL},},
  ...
  {"pages/page", 32, &A2406p, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2406p, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2406p, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2406p, ft_binary, fc_stable, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
  ...
  {"channels",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_channel}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"channels",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_channel}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"channels",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_channel}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"channels",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_channel}, {o: NULL}, {v:NULL},},
  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_stable,  {o:FS_r_pio}, {o:FS_w_pio}, {v:NULL},},  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_stable,  {o:FS_r_pio}, {o:FS_w_pio}, {v:NULL},},  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_stable,  {o:FS_r_pio}, {o:FS_w_pio}, {v:NULL},},  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_stable, {o: FS_r_pio}, {o: FS_w_pio}, {v:NULL},},
  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile,  {o:FS_sense}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile,  {o:FS_sense}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile,  {o:FS_sense}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile, {o: FS_sense}, {o: NULL}, {v:NULL},},
  {"latch",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile,  {o:FS_r_latch}, {o:FS_w_latch}, {v:NULL},},  {"latch",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile,  {o:FS_r_latch}, {o:FS_w_latch}, {v:NULL},},  {"latch",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile,  {o:FS_r_latch}, {o:FS_w_latch}, {v:NULL},},  {"latch",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile, {o: FS_r_latch}, {o: FS_w_latch}, {v:NULL},},
...
#if OW_TAI8570
  {"TAI8570",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {o: NULL}, {o: NULL}, {v:NULL},},
  {"TAI8570/temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile,  {o:FS_temp}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile,  {o:FS_temp}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile,  {o:FS_temp}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_temp}, {o: NULL}, {v:NULL},},
  {"TAI8570/pressure",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile,  {o:FS_pressure}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/pressure",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile,  {o:FS_pressure}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/pressure",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile,  {o:FS_pressure}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/pressure",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_pressure}, {o: NULL}, {v:NULL},},
  {"TAI8570/sibling", 16, NULL, ft_ascii, fc_stable,  {o:FS_sibling}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/sibling", 16, NULL, ft_ascii, fc_stable,  {o:FS_sibling}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/sibling", 16, NULL, ft_ascii, fc_stable,  {o:FS_sibling}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"TAI8570/sibling", 16, NULL, ft_ascii, fc_stable, {o: FS_sibling}, {o: NULL}, {v:NULL},},
#endif							/* OW_TAI8570 */
};
					...
					const off_t offset, const struct parsedname *pn)
{
	...
	for (i = 1; i < size; ++i) {
		...
		if ((++p[1]) == 0x00)
			++p[2];
		if (BUS_transaction(trest, pn))
			return 1;
		if (CRC16(&p[1], 5) || (resp & ~data[i]))
			return 1;
	}
	return 0;
}
