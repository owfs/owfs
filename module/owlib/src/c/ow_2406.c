...
struct filetype DS2406[] = {
  ...
  {"channels",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_channel}, {o: NULL}, {v:NULL},},
  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_stable, {o: FS_r_pio}, {o: FS_w_pio}, {v:NULL},},
  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2406, ft_bitfield, fc_volatile, {o: FS_sense}, {o: NULL}, {v:NULL},},
...
#if OW_TAI8570
  {"TAI8570",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {o: NULL}, {o: NULL}, {v:NULL},},
  {"TAI8570/temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_temp}, {o: NULL}, {v:NULL},},
  {"TAI8570/pressure",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_pressure}, {o: NULL}, {v:NULL},},
  {"TAI8570/sibling", 16, NULL, ft_ascii, fc_stable, {o: FS_sibling}, {o: NULL}, {v:NULL},},
#endif							/* OW_TAI8570 */
};
