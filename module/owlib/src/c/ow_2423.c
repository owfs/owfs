...
struct filetype DS2423[] = {
  ...
  {"pages/page", 32, &A2423, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2423, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2423, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2423, ft_binary, fc_stable, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
  {"counters",PROPERTY_LENGTH_UNSIGNED, &A2423c, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"counters",PROPERTY_LENGTH_UNSIGNED, &A2423c, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"counters",PROPERTY_LENGTH_UNSIGNED, &A2423c, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"counters",PROPERTY_LENGTH_UNSIGNED, &A2423c, ft_unsigned, fc_volatile, {o: FS_counter}, {o: NULL}, {v:NULL},},
#if OW_CACHE
  {"mincount",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_mincount}, {o:FS_w_mincount}, {v:NULL},},  {"mincount",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_mincount}, {o:FS_w_mincount}, {v:NULL},},  {"mincount",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_mincount}, {o:FS_w_mincount}, {v:NULL},},  {"mincount",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_mincount}, {o: FS_w_mincount}, {v:NULL},},
#endif							/*OW_CACHE */
  {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A2423, ft_unsigned, fc_volatile,  {o:FS_pagecount}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A2423, ft_unsigned, fc_volatile,  {o:FS_pagecount}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A2423, ft_unsigned, fc_volatile,  {o:FS_pagecount}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A2423, ft_unsigned, fc_volatile, {o: FS_pagecount}, {o: NULL}, {v:NULL},},
};
...
static int FS_r_mincount(struct one_wire_query * owq)
{
    ...
    if ( Cache_Add_Internal((void *) st, 3 * sizeof(UINT), &ip_cum, pn) )
        return -EINVAL ;
    return 0 ;
}
