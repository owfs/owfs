...
{"typeB"            ,PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir  , fc_volatile,   NO_READ_FUNCTION, NO_WRITE_FUNCTION     , VISIBLE, NO_FILETYPE_DATA, } , \
...
{"typeB/range_high" ,PROPERTY_LENGTH_TEMP, NON_AGGREGATE,ft_temperature, fc_static  ,   FS_rangehigh, NO_WRITE_FUNCTION     , VISIBLE, {i:e_type_b}, } , \
    \
    {"typeE"            ,PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir  , fc_volatile,   NO_READ_FUNCTION, NO_WRITE_FUNCTION     , VISIBLE, NO_FILETYPE_DATA, } , \
    ...
    \
    {"typeJ"            ,PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir  , fc_volatile,   NO_READ_FUNCTION, NO_WRITE_FUNCTION     , VISIBLE, NO_FILETYPE_DATA, } , \
    ...
    \
    {"typeK"            ,PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir  , fc_volatile,   NO_READ_FUNCTION, NO_WRITE_FUNCTION     , VISIBLE, NO_FILETYPE_DATA, } , \
    ...
    \
    {"typeN"            ,PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir  , fc_volatile,   NO_READ_FUNCTION, NO_WRITE_FUNCTION     , VISIBLE, NO_FILETYPE_DATA, } , \
    ...
    \
    {"typeR"            ,PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir  , fc_volatile,   NO_READ_FUNCTION, NO_WRITE_FUNCTION     , VISIBLE, NO_FILETYPE_DATA, } , \
    ...
    \
    {"typeS"            ,PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir  , fc_volatile,   NO_READ_FUNCTION, NO_WRITE_FUNCTION     , VISIBLE, NO_FILETYPE_DATA, } , \
    ...
    \
    {"typeT"            ,PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir  , fc_volatile,   NO_READ_FUNCTION, NO_WRITE_FUNCTION     , VISIBLE, NO_FILETYPE_DATA, } , \
...
struct filetype DS2720[] = {
  ...
  {"memory", 256, NULL, ft_binary, fc_volatile, FS_r_mem, FS_w_mem, VISIBLE, NO_FILETYPE_DATA,},
  {"pages", PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"pages/page", Size2720, &L2720, ft_binary, fc_volatile, FS_r_page, FS_w_page, VISIBLE, {v:&P2720},},
...
struct filetype DS2740[] = {
  F_STANDARD,
  {"memory", 256, NON_AGGREGATE, ft_binary, fc_volatile, FS_r_mem, FS_w_mem, VISIBLE, NO_FILETYPE_DATA,},
...
struct filetype DS2751[] = {
  ...
  {"pages/page", Size2751, &L2751, ft_binary, fc_volatile, FS_r_page, FS_w_page, VISIBLE, {v:&P2751},},
...
struct filetype DS2755[] = {
  ...
  {"memory", 256, NON_AGGREGATE, ft_binary, fc_volatile, FS_r_mem, FS_w_mem, VISIBLE, NO_FILETYPE_DATA,},
  {"pages", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"pages/page", Size2755, &L2755, ft_binary, fc_volatile, FS_r_page, FS_w_page, VISIBLE, {v:&P2755},},
  {"PIO", PROPERTY_LENGTH_YESNO, NON_AGGREGATE, ft_yesno, fc_volatile, NO_READ_FUNCTION, FS_w_pio, VISIBLE, {u:(_1W_DS2760_SPECIAL_REG << 8) | 6},},
  {"sensed", PROPERTY_LENGTH_YESNO, NON_AGGREGATE, ft_yesno, fc_volatile, FS_r_bit, NO_WRITE_FUNCTION, VISIBLE, {u:(_1W_DS2760_SPECIAL_REG << 8) | 6},},
  {"temperature", PROPERTY_LENGTH_TEMP, NON_AGGREGATE, ft_temperature, fc_volatile, FS_r_temp, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"vbias", PROPERTY_LENGTH_FLOAT, NON_AGGREGATE, ft_float, fc_stable, FS_r_vbias, FS_w_vbias, VISIBLE, NO_FILETYPE_DATA,},
...
struct filetype DS2760[] = {
  ...
  {"memory", 256, NON_AGGREGATE, ft_binary, fc_volatile, FS_r_mem, FS_w_mem, VISIBLE, NO_FILETYPE_DATA,},
  {"pages", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"pages/page", Size2760, &L2760, ft_binary, fc_volatile, FS_r_page, FS_w_page, VISIBLE, {v:&P2760},},
  {"PIO", PROPERTY_LENGTH_YESNO, NON_AGGREGATE, ft_yesno, fc_volatile, NO_READ_FUNCTION, FS_w_pio, VISIBLE, {u:(_1W_DS2760_SPECIAL_REG << 8) | 6},},
  {"sensed", PROPERTY_LENGTH_YESNO, NON_AGGREGATE, ft_yesno, fc_volatile, FS_r_bit, NO_WRITE_FUNCTION, VISIBLE, {u:(_1W_DS2760_SPECIAL_REG << 8) | 6},},
  {"temperature", PROPERTY_LENGTH_TEMP, NON_AGGREGATE, ft_temperature, fc_volatile, FS_r_temp, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"vbias", PROPERTY_LENGTH_FLOAT, NON_AGGREGATE, ft_float, fc_stable, FS_r_vbias, FS_w_vbias, VISIBLE, NO_FILETYPE_DATA,},
...
struct filetype DS2770[] = {
  ...
  {"memory", 256, NON_AGGREGATE, ft_binary, fc_volatile, FS_r_mem, FS_w_mem, VISIBLE, NO_FILETYPE_DATA,},
  {"pages", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"pages/page", Size2770, &L2770, ft_binary, fc_volatile, FS_r_page, FS_w_page, VISIBLE, {v:&P2770},},
  {"temperature", PROPERTY_LENGTH_TEMP, NON_AGGREGATE, ft_temperature, fc_volatile, FS_r_temp, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"vbias", PROPERTY_LENGTH_FLOAT, NON_AGGREGATE, ft_float, fc_stable, FS_r_vbias, FS_w_vbias, VISIBLE, NO_FILETYPE_DATA,},
  {"vis", PROPERTY_LENGTH_FLOAT, NON_AGGREGATE, ft_float, fc_volatile, FS_r_vis, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"volt", PROPERTY_LENGTH_FLOAT, NON_AGGREGATE, ft_float, fc_volatile, FS_r_volt, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
...
struct filetype DS2780[] = {
  ...
  {"memory", 256, NON_AGGREGATE, ft_binary, fc_volatile, FS_r_mem, FS_w_mem, VISIBLE, NO_FILETYPE_DATA,},
  {"pages", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, VISIBLE, NO_FILETYPE_DATA,},
  {"pages/page", Size2780, &L2780, ft_binary, fc_volatile, FS_r_page, FS_w_page, VISIBLE, {v:&P2780},},
