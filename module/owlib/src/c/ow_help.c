...
"  and man pages for individual 1-wire devices e.g. 'man DS2409'\n"
        ,SAFESTRING(Global.progname),SAFESTRING(Global.progname),SAFESTRING(Global.progname),SAFESTRING(Global.progname),SAFESTRING(Global.progname),SAFESTRING(Global.progname),SAFESTRING(Global.progname)
) ;
}
