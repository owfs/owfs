...
static int FS_dir_seek(void (*dirfunc) (void *, const struct parsedname * const),
                       void * v, struct connection_in *in,
                       const struct parsedname *pn, uint32_t * flags);
static int FS_devdir(void (*dirfunc) (void *, const struct parsedname * const),
                     void * v, struct parsedname *pn2);
static int FS_alarmdir(void (*dirfunc) (void *, const struct parsedname * const),
                       void * v, struct parsedname *pn2);
static int FS_typedir(void (*dirfunc) (void *, const struct parsedname * const),
                      void * v, struct parsedname *pn2);
static int FS_realdir(void (*dirfunc) (void *, const struct parsedname * const),
                      void * v, struct parsedname *pn2, uint32_t * flags);
static int FS_cache2real(void (*dirfunc) (void *, const struct parsedname * const),
                         void * v, struct parsedname *pn2, uint32_t * flags);
                       ...
                       void * v, const struct parsedname *pn, uint32_t * flags)
{
    ...
    if (pn->ft) {
        ...
        //printf("ALARM\n");
        ret =
            SpecifiedBus(pn) ? FS_alarmdir(dirfunc, v, &pn2)
        ...
        ret =
            SpecifiedBus(pn) ? FS_cache2real(dirfunc, v, &pn2, flags)
                             : FS_dir_seek(dirfunc, v, pn2.in, &pn2, flags);
    }
...
static void *FS_dir_seek_callback(void *v)
{
    ...
    dss->ret = FS_dir_seek(dss->dirfunc, dss->v, dss->in, dss->pn, dss->flags);
    pthread_exit(NULL);
    return NULL;
}
...
static int FS_cache2real(void (*dirfunc) (void *, const struct parsedname *),
                         void * v, struct parsedname *pn2, uint32_t * flags)
{
    size_t dindex;
    struct dirblob db;
