...
struct filetype DS1963S[] = {
    ...
    {"pages/page", 32, &A1963S, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},    {"pages/page", 32, &A1963S, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},    {"pages/page", 32, &A1963S, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},    {"pages/page", 32, &A1963S, ft_binary, fc_stable, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
    {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A1963S, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A1963S, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A1963S, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A1963S, ft_unsigned, fc_volatile, {o: FS_counter}, {o: NULL}, {v:NULL},},
    {"pages/password", 8, NULL, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},    {"pages/password", 8, NULL, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},    {"pages/password", 8, NULL, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},    {"pages/password", 8, NULL, ft_binary, fc_stable, {o: NULL}, {o: FS_w_password}, {v:NULL},},
    ...
    {"password", 8, NULL, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},    {"password", 8, NULL, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},    {"password", 8, NULL, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},    {"password", 8, NULL, ft_binary, fc_stable, {o: NULL}, {o: FS_w_password}, {v:NULL},},
};
...
struct filetype DS1963L[] = {
    F_STANDARD,
    {"pages",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {o: NULL}, {o: NULL}, {v:NULL},},
    {"pages/page", 32, &A1963L, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v: NULL},},    {"pages/page", 32, &A1963L, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v: NULL},},    {"pages/page", 32, &A1963L, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v: NULL},},    {"pages/page", 32, &A1963L, ft_binary, fc_stable, {o: FS_r_page}, {o: FS_w_page}, {v: NULL},},
    {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A1963L, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A1963L, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A1963L, ft_unsigned, fc_volatile,  {o:FS_counter}, {o:NO_WRITE_FUNCTION}, {v:NULL},},    {"pages/count",PROPERTY_LENGTH_UNSIGNED, &A1963L, ft_unsigned, fc_volatile, {o: FS_counter}, {o: NULL}, {v:NULL},},
    {"memory", 512, NULL, ft_binary, fc_stable,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},    {"memory", 512, NULL, ft_binary, fc_stable,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},    {"memory", 512, NULL, ft_binary, fc_stable,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},    {"memory", 512, NULL, ft_binary, fc_stable, {o: FS_r_memory}, {o: FS_w_memory}, {v:NULL},},
};
