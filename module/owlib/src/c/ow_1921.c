...
struct filetype DS1921[] = {
  ...
  {"histogram/gap", PROPERTY_LENGTH_FLOAT, NULL, ft_tempgap, fc_static, {o: FS_r_histogap}, {v: NULL}, {v:NULL},},
  {"histogram/temperature", PROPERTY_LENGTH_FLOAT, &A1921h, ft_temperature, fc_static, {o: FS_r_histotemp}, {v: NULL}, {v:NULL},},
  ...
  {"about/resolution", PROPERTY_LENGTH_FLOAT, NULL, ft_tempgap, fc_static, {o: FS_r_resolution}, {v: NULL}, {v:NULL},},
  {"about/templow", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_static, {o: FS_r_rangelow}, {v: NULL}, {v:NULL},},
  ...
  {"overtemp/temperature", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_stable, {o: FS_r_alarmtemp}, {o: FS_w_alarmtemp}, {s:0x020C},},
  ...
  {"undertemp/temperature", PROPERTY_LENGTH_FLOAT, NULL, ft_temperature, fc_stable, {o: FS_r_alarmtemp}, {o: FS_w_alarmtemp}, {s:0x020C},},

  {"log", 0, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"log/temperature", PROPERTY_LENGTH_FLOAT, &A1921l, ft_temperature, fc_volatile, {o: FS_r_logtemp}, {v: NULL}, {v:NULL},},
