...
struct filetype DS1921[] = {
  ...
  {"histogram",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"histogram/counts",PROPERTY_LENGTH_UNSIGNED, &A1921h, ft_unsigned, fc_volatile, {o: FS_r_histogram}, {v: NULL}, {v:NULL},},
  {"histogram/elements",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_static, {o: FS_r_histoelem}, {v: NULL}, {v:NULL},},
  {"histogram/gap",PROPERTY_LENGTH_TEMPGAP, NULL, ft_tempgap, fc_static, {o: FS_r_histogap}, {v: NULL}, {v:NULL},},
  {"histogram/temperature",PROPERTY_LENGTH_TEMP, &A1921h, ft_temperature, fc_static, {o: FS_r_histotemp}, {v: NULL}, {v:NULL},},
  ...
  {"about",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"about/resolution",PROPERTY_LENGTH_TEMPGAP, NULL, ft_tempgap, fc_static, {o: FS_r_resolution}, {v: NULL}, {v:NULL},},
  {"about/templow",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_static, {o: FS_r_rangelow}, {v: NULL}, {v:NULL},},
  {"about/temphigh",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_static, {o: FS_r_rangehigh}, {v: NULL}, {v:NULL},},
  ...
  {"mission/samples",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_3byte}, {v: NULL}, {s:0x021A},},
  ...
  {"overtemp",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"overtemp/date",PROPERTY_LENGTH_DATE, &A1921m, ft_date, fc_volatile, {o: FS_alarmstart}, {v: NULL}, {s:0x0250},},
  {"overtemp/udate",PROPERTY_LENGTH_UNSIGNED, &A1921m, ft_unsigned, fc_volatile, {o: FS_alarmudate}, {v: NULL}, {s:0x0250},},
  {"overtemp/end",PROPERTY_LENGTH_DATE, &A1921m, ft_date, fc_volatile, {o: FS_alarmend}, {v: NULL}, {s:0x0250},},
  {"overtemp/count",PROPERTY_LENGTH_UNSIGNED, &A1921m, ft_unsigned, fc_volatile, {o: FS_alarmcnt}, {v: NULL}, {s:0x0250},},
  {"overtemp/elements",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_alarmelems}, {v: NULL}, {s:0x0250},},
  {"overtemp/temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_stable, {o: FS_r_alarmtemp}, {o: FS_w_alarmtemp}, {s:0x020C},},

  {"undertemp",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"undertemp/date",PROPERTY_LENGTH_DATE, &A1921m, ft_date, fc_volatile, {o: FS_alarmstart}, {v: NULL}, {s:0x0220},},
  {"undertemp/udate",PROPERTY_LENGTH_UNSIGNED, &A1921m, ft_unsigned, fc_volatile, {o: FS_alarmudate}, {v: NULL}, {s:0x0220},},
  {"undertemp/end",PROPERTY_LENGTH_DATE, &A1921m, ft_date, fc_volatile, {o: FS_alarmend}, {v: NULL}, {s:0x0220},},
  {"undertemp/count",PROPERTY_LENGTH_UNSIGNED, &A1921m, ft_unsigned, fc_volatile, {o: FS_alarmcnt}, {v: NULL}, {s:0x0220},},
  {"undertemp/elements",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_alarmelems}, {v: NULL}, {s:0x0220},},
  {"undertemp/temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_stable, {o: FS_r_alarmtemp}, {o: FS_w_alarmtemp}, {s:0x020C},},

  {"log",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"log/temperature",PROPERTY_LENGTH_TEMP, &A1921l, ft_temperature, fc_volatile, {o: FS_r_logtemp}, {v: NULL}, {v:NULL},},
  {"log/date",PROPERTY_LENGTH_DATE, &A1921l, ft_date, fc_volatile, {o: FS_r_logdate}, {v: NULL}, {v:NULL},},
