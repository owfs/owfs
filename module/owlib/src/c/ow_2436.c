...
struct filetype DS2436[] = {
  ...
  {"pages/page", 32, &A2436, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2436, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2436, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2436, ft_binary, fc_stable, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
  {"volts",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile,  {o:FS_volts}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"volts",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile,  {o:FS_volts}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"volts",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile,  {o:FS_volts}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"volts",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_volts}, {o: NULL}, {v:NULL},},
