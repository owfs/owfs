...
struct filetype DS2404[] = {
	F_STANDARD,
  {"alarm",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_alarm}, {v: NULL}, {v:NULL},},
  {"set_alarm",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_r_set_alarm}, {o: FS_w_set_alarm}, {v:NULL},},
  ...
  {"running",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_flag}, {o: FS_w_flag}, {c:0x10},},
  {"auto",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_flag}, {o: FS_w_flag}, {c:0x20},},
  {"start",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_flag}, {o: FS_w_flag}, {c:0x40},},
  {"delay",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_flag}, {o: FS_w_flag}, {c:0x80},},
  ...
  {"interval",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second, {o: FS_r_date}, {o: FS_w_date}, {s:0x207},},
  {"uinterval",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter5}, {o: FS_w_counter5}, {s:0x207},},
  {"cycle",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter4}, {o: FS_w_counter4}, {s:0x20C},},
  {"trigger",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"trigger/date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second, {o: FS_r_date}, {o: FS_w_date}, {s:0x210},},
  {"trigger/udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter5}, {o: FS_w_counter5}, {s:0x210},},
  {"trigger/interval",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second, {o: FS_r_date}, {o: FS_w_date}, {s:0x215},},
  {"trigger/uinterval",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter5}, {o: FS_w_counter5}, {s:0x215},},
  {"trigger/cycle",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter4}, {o: FS_w_counter4}, {s:0x21A},},
  {"readonly",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"readonly/memory",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_flag}, {o: FS_w_flag}, {c:0x08},},
  {"readonly/cycle",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_flag}, {o: FS_w_flag}, {c:0x04},},
  {"readonly/interval",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_flag}, {o: FS_w_flag}, {c:0x02},},
  {"readonly/clock",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_flag}, {o: FS_w_flag}, {c:0x01},},
};
