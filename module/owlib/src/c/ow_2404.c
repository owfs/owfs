...
struct filetype DS2404[] = {
	F_STANDARD,
  {"alarm",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_alarm}, {o: NULL}, {v:NULL},},
  ...
  {"readonly",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {o: NULL}, {o: NULL}, {v:NULL},},
