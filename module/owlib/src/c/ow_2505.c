...
struct filetype DS2505[] = {
	F_STANDARD,
	{"status", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, NO_PROPERTY_DATA,},
  {"status/page", 8, &A2505s, ft_binary, fc_stable, FS_r_status, FS_w_status, NO_PROPERTY_DATA,},
  {"memory", 2048, NON_AGGREGATE, ft_binary, fc_stable, FS_r_memory, FS_w_memory, NO_PROPERTY_DATA,},
  {"pages", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, NO_PROPERTY_DATA,},
  {"pages/page", 32, &A2505, ft_binary, fc_stable, FS_r_page, FS_w_page, NO_PROPERTY_DATA,},
};
...
struct filetype DS2506[] = {
	F_STANDARD,
	{"status", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, NO_PROPERTY_DATA,},
  {"status/page", 32, &A2506s, ft_binary, fc_stable, FS_r_status, FS_w_status, NO_PROPERTY_DATA,},
  {"memory", 8192, NON_AGGREGATE, ft_binary, fc_stable, FS_r_memory, FS_w_memory, NO_PROPERTY_DATA,},
  {"pages", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, NO_PROPERTY_DATA,},
  {"pages/page", 32, &A2506, ft_binary, fc_stable, FS_r_page, FS_w_page, NO_PROPERTY_DATA,},
};
