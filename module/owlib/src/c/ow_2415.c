...
struct filetype DS2415[] = {
	F_STANDARD,
  {"flags",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_r_flags}, {o:FS_w_flags}, {v:NULL},},  {"flags",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_r_flags}, {o:FS_w_flags}, {v:NULL},},  {"flags",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_r_flags}, {o:FS_w_flags}, {v:NULL},},  {"flags",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_r_flags}, {o: FS_w_flags}, {v:NULL},},
  ...
  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second,  {o:FS_r_counter}, {o:FS_w_counter}, {v:NULL},},  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second,  {o:FS_r_counter}, {o:FS_w_counter}, {v:NULL},},  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second,  {o:FS_r_counter}, {o:FS_w_counter}, {v:NULL},},  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter}, {o: FS_w_counter}, {v:NULL},},
  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second,  {o:FS_r_date}, {o:FS_w_date}, {v:NULL},},  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second,  {o:FS_r_date}, {o:FS_w_date}, {v:NULL},},  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second,  {o:FS_r_date}, {o:FS_w_date}, {v:NULL},},  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second, {o: FS_r_date}, {o: FS_w_date}, {v:NULL},},
};
...
struct filetype DS2417[] = {
	F_STANDARD,
  {"enable",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_enable}, {o:FS_w_enable}, {v:NULL},},  {"enable",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_enable}, {o:FS_w_enable}, {v:NULL},},  {"enable",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_enable}, {o:FS_w_enable}, {v:NULL},},  {"enable",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_enable}, {o: FS_w_enable}, {v:NULL},},
  {"interval",PROPERTY_LENGTH_INTEGER, NULL, ft_integer, fc_stable,  {o:FS_r_interval}, {o:FS_w_interval}, {v:NULL},},  {"interval",PROPERTY_LENGTH_INTEGER, NULL, ft_integer, fc_stable,  {o:FS_r_interval}, {o:FS_w_interval}, {v:NULL},},  {"interval",PROPERTY_LENGTH_INTEGER, NULL, ft_integer, fc_stable,  {o:FS_r_interval}, {o:FS_w_interval}, {v:NULL},},  {"interval",PROPERTY_LENGTH_INTEGER, NULL, ft_integer, fc_stable, {o: FS_r_interval}, {o: FS_w_interval}, {v:NULL},},
  {"itime",PROPERTY_LENGTH_INTEGER, NULL, ft_integer, fc_stable,  {o:FS_r_itime}, {o:FS_w_itime}, {v:NULL},},  {"itime",PROPERTY_LENGTH_INTEGER, NULL, ft_integer, fc_stable,  {o:FS_r_itime}, {o:FS_w_itime}, {v:NULL},},  {"itime",PROPERTY_LENGTH_INTEGER, NULL, ft_integer, fc_stable,  {o:FS_r_itime}, {o:FS_w_itime}, {v:NULL},},  {"itime",PROPERTY_LENGTH_INTEGER, NULL, ft_integer, fc_stable, {o: FS_r_itime}, {o: FS_w_itime}, {v:NULL},},
  {"running",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_run}, {o:FS_w_run}, {v:NULL},},  {"running",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_run}, {o:FS_w_run}, {v:NULL},},  {"running",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_run}, {o:FS_w_run}, {v:NULL},},  {"running",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_run}, {o: FS_w_run}, {v:NULL},},
  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second,  {o:FS_r_counter}, {o:FS_w_counter}, {v:NULL},},  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second,  {o:FS_r_counter}, {o:FS_w_counter}, {v:NULL},},  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second,  {o:FS_r_counter}, {o:FS_w_counter}, {v:NULL},},  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter}, {o: FS_w_counter}, {v:NULL},},
  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second,  {o:FS_r_date}, {o:FS_w_date}, {v:NULL},},  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second,  {o:FS_r_date}, {o:FS_w_date}, {v:NULL},},  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second,  {o:FS_r_date}, {o:FS_w_date}, {v:NULL},},  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second, {o: FS_r_date}, {o: FS_w_date}, {v:NULL},},
};
