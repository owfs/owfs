...
struct filetype DS1991[] = {
	F_STANDARD,
  {"settings",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {o: NULL}, {o: NULL}, {v:NULL},},
  {"settings/reset_password", 8, &A1991, ft_binary, fc_stable, {o: NULL}, {o: FS_w_reset_password}, {v:NULL},},
  {"settings/change_password", 8, &A1991, ft_binary, fc_stable, {o: NULL}, {o: FS_w_change_password}, {v:NULL},},
  {"settings/password", 8, &A1991, ft_binary, fc_stable, {o: NULL}, {o: FS_w_password}, {v:NULL},},
  ...
  {"pages/password", 8, &A1991, ft_binary, fc_stable, {o: NULL}, {o: FS_w_password}, {v:NULL},},
