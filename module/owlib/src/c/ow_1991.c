...
struct filetype DS1991[] = {
	F_STANDARD,
  {"settings",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"settings",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"settings",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile,  {o:NO_READ_FUNCTION}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"settings",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {o: NULL}, {o: NULL}, {v:NULL},},
  {"settings/reset_password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_reset_password}, {v:NULL},},  {"settings/reset_password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_reset_password}, {v:NULL},},  {"settings/reset_password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_reset_password}, {v:NULL},},  {"settings/reset_password", 8, &A1991, ft_binary, fc_stable, {o: NULL}, {o: FS_w_reset_password}, {v:NULL},},
  {"settings/change_password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_change_password}, {v:NULL},},  {"settings/change_password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_change_password}, {v:NULL},},  {"settings/change_password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_change_password}, {v:NULL},},  {"settings/change_password", 8, &A1991, ft_binary, fc_stable, {o: NULL}, {o: FS_w_change_password}, {v:NULL},},
  {"settings/password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},  {"settings/password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},  {"settings/password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},  {"settings/password", 8, &A1991, ft_binary, fc_stable, {o: NULL}, {o: FS_w_password}, {v:NULL},},
  {"settings/ident", 8, &A1991, ft_binary, fc_volatile,  {o:FS_r_ident}, {o:FS_w_ident}, {v:NULL},},  {"settings/ident", 8, &A1991, ft_binary, fc_volatile,  {o:FS_r_ident}, {o:FS_w_ident}, {v:NULL},},  {"settings/ident", 8, &A1991, ft_binary, fc_volatile,  {o:FS_r_ident}, {o:FS_w_ident}, {v:NULL},},  {"settings/ident", 8, &A1991, ft_binary, fc_volatile, {o: FS_r_ident}, {o: FS_w_ident}, {v:NULL},},
  {"settings/page", 48, &A1991, ft_binary, fc_volatile,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"settings/page", 48, &A1991, ft_binary, fc_volatile,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"settings/page", 48, &A1991, ft_binary, fc_volatile,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"settings/page", 48, &A1991, ft_binary, fc_volatile, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
  ...
  {"pages/page", 48, &A1991, ft_binary, fc_volatile,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 48, &A1991, ft_binary, fc_volatile,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 48, &A1991, ft_binary, fc_volatile,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 48, &A1991, ft_binary, fc_volatile, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
  {"pages/password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},  {"pages/password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},  {"pages/password", 8, &A1991, ft_binary, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_password}, {v:NULL},},  {"pages/password", 8, &A1991, ft_binary, fc_stable, {o: NULL}, {o: FS_w_password}, {v:NULL},},
  {"pages/ident", 8, &A1991, ft_binary, fc_volatile,  {o:FS_r_ident}, {o:FS_w_ident}, {v:NULL},},  {"pages/ident", 8, &A1991, ft_binary, fc_volatile,  {o:FS_r_ident}, {o:FS_w_ident}, {v:NULL},},  {"pages/ident", 8, &A1991, ft_binary, fc_volatile,  {o:FS_r_ident}, {o:FS_w_ident}, {v:NULL},},  {"pages/ident", 8, &A1991, ft_binary, fc_volatile, {o: FS_r_ident}, {o: FS_w_ident}, {v:NULL},},
  {"memory", 144, NULL, ft_binary, fc_volatile,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},  {"memory", 144, NULL, ft_binary, fc_volatile,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},  {"memory", 144, NULL, ft_binary, fc_volatile,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},  {"memory", 144, NULL, ft_binary, fc_volatile, {o: FS_r_memory}, {o: FS_w_memory}, {v:NULL},},
};
