...
struct filetype DS1991[] = {
    F_STANDARD ,
    {"settings" ,       0,  NULL,   ft_subdir, ft_volatile, {v:NULL}, {v:NULL}, NULL, } ,
    {"settings/reset_password",  8, &A1991, ft_binary, ft_stable ,  {v:NULL} , {b:FS_w_reset_password}, NULL, } ,
    {"settings/change_password", 8, &A1991, ft_binary, ft_stable ,  {v:NULL} , {b:FS_w_change_password}, NULL, } ,
    {"settings/password", 8, &A1991,ft_binary, ft_stable ,          {v:NULL} , {b:FS_w_password}, NULL, } ,
    {"settings/ident",  8,  &A1991, ft_binary, ft_volatile ,  {b:FS_r_ident} , {b:FS_w_ident}, NULL, } ,
    {"settings/page",  48,  &A1991, ft_binary, ft_volatile ,   {b:FS_r_page} , {b:FS_w_page}, NULL, } ,
    {"pages" ,          0,  NULL,   ft_subdir, ft_volatile,         {v:NULL} , {v:NULL}, NULL, } ,
    {"pages/page" ,    48,  &A1991, ft_binary, ft_volatile ,   {b:FS_r_page} , {b:FS_w_page}, NULL, } ,
    {"pages/password" , 8,  &A1991, ft_binary, ft_stable ,          {v:NULL} , {b:FS_w_password}, NULL, } ,
