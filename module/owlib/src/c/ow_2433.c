...
struct filetype DS2431[] = {
  ...
  {"pages/page", 32, &A2431, ft_binary, fc_stable, FS_r_page, FS_w_page2D, NO_FILETYPE_DATA,},
  {"memory", 128, NON_AGGREGATE, ft_binary, fc_stable, FS_r_memory, FS_w_memory2D, NO_FILETYPE_DATA,},
};
...
struct filetype DS2433[] = {
	F_STANDARD,
	{"pages", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, NO_FILETYPE_DATA,},
  {"pages/page", 32, &A2433, ft_binary, fc_stable, FS_r_page, FS_w_page, NO_FILETYPE_DATA,},
...
struct filetype DS28EC20[] = {
	F_STANDARD,
	{"pages", PROPERTY_LENGTH_SUBDIR, NON_AGGREGATE, ft_subdir, fc_volatile, NO_READ_FUNCTION, NO_WRITE_FUNCTION, NO_FILETYPE_DATA,},
  {"pages/page", 32, &A28EC20, ft_binary, fc_stable, FS_r_page, FS_w_page, NO_FILETYPE_DATA,},
  {"memory", 2560, NON_AGGREGATE, ft_binary, fc_stable, FS_r_memory, FS_w_memory, NO_FILETYPE_DATA,},
};
