...
static int DS9490_redetect_low( const struct parsedname * pn ) {
    ...
    while ( !USB_next(&ul) ) {
        ...
        free( name ) ; // use pn->in->name created in DS990_open instead
