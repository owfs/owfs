...
struct filetype DS2430A[] = {
	F_STANDARD,
	{"memory", 16, NON_AGGREGATE, ft_binary, fc_stable, FS_r_memory, FS_w_memory, NO_FILETYPE_DATA,},
	{"application", 8, NON_AGGREGATE, ft_binary, fc_stable, FS_r_application, FS_w_application, NO_FILETYPE_DATA,},
	{"lock", PROPERTY_LENGTH_YESNO, NON_AGGREGATE, ft_yesno, fc_stable, FS_r_lock, NO_WRITE_FUNCTION, NO_FILETYPE_DATA,},
};
