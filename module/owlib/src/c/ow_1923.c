...
{"mission/delay",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,   FS_r_delay, FS_w_delay, {v:NULL},} ,
{"mission/date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_volatile, {d: FS_mdate},   NO_READ_FUNCTION, NO_WRITE_FUNCTION,},{"mission/date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_volatile, {d: FS_mdate} ,
