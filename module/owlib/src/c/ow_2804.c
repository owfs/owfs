...
struct filetype DS28E04[] = {
	F_STANDARD,
  {"memory", 550, NULL, ft_binary, fc_stable,  {o:FS_r_mem}, {o:FS_w_mem}, {v:NULL},},  {"memory", 550, NULL, ft_binary, fc_stable,  {o:FS_r_mem}, {o:FS_w_mem}, {v:NULL},},  {"memory", 550, NULL, ft_binary, fc_stable,  {o:FS_r_mem}, {o:FS_w_mem}, {v:NULL},},  {"memory", 550, NULL, ft_binary, fc_stable, {o: FS_r_mem}, {o: FS_w_mem}, {v:NULL},},
  ...
  {"pages/page", 32, &A2804p, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2804p, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2804p, ft_binary, fc_stable,  {o:FS_r_page}, {o:FS_w_page}, {v:NULL},},  {"pages/page", 32, &A2804p, ft_binary, fc_stable, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
  {"polarity",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile,  {o:FS_polarity}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"polarity",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile,  {o:FS_polarity}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"polarity",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile,  {o:FS_polarity}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"polarity",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_polarity}, {o: NULL}, {v:NULL},},
  ...
  {"por",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile,  {o:FS_r_por}, {o:FS_w_por}, {v:NULL},},  {"por",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile,  {o:FS_r_por}, {o:FS_w_por}, {v:NULL},},  {"por",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile,  {o:FS_r_por}, {o:FS_w_por}, {v:NULL},},  {"por",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_volatile, {o: FS_r_por}, {o: FS_w_por}, {v:NULL},},
  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_stable,  {o:FS_r_pio}, {o:FS_w_pio}, {v:NULL},},  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_stable,  {o:FS_r_pio}, {o:FS_w_pio}, {v:NULL},},  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_stable,  {o:FS_r_pio}, {o:FS_w_pio}, {v:NULL},},  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_stable, {o: FS_r_pio}, {o: FS_w_pio}, {v:NULL},},
  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_volatile,  {o:FS_sense}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_volatile,  {o:FS_sense}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_volatile,  {o:FS_sense}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_volatile, {o: FS_sense}, {o: NULL}, {v:NULL},},
  {"latch",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_volatile,  {o:FS_r_latch}, {o:FS_w_latch}, {v:NULL},},  {"latch",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_volatile,  {o:FS_r_latch}, {o:FS_w_latch}, {v:NULL},},  {"latch",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_volatile,  {o:FS_r_latch}, {o:FS_w_latch}, {v:NULL},},  {"latch",PROPERTY_LENGTH_BITFIELD, &A2804, ft_bitfield, fc_volatile, {o: FS_r_latch}, {o: FS_w_latch}, {v:NULL},},
