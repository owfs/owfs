...
struct filetype DS2408[] = {
  ...
  {"PIO",PROPERTY_LENGTH_BITFIELD, &A2408, ft_bitfield, fc_stable, {o: FS_r_pio}, {o: FS_w_pio}, {v:NULL},},
  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2408, ft_bitfield, fc_volatile, {o: FS_sense}, {v: NULL}, {v:NULL},},
  {"latch",PROPERTY_LENGTH_BITFIELD, &A2408, ft_bitfield, fc_volatile, {o: FS_r_latch}, {o: FS_w_latch}, {v:NULL},},
  {"strobe",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_strobe}, {o: FS_w_strobe}, {v:NULL},},
  {"set_alarm",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_r_s_alarm}, {o: FS_w_s_alarm}, {v:NULL},},
  {"por",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_por}, {o: FS_w_por}, {v:NULL},},
  {"LCD_M",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {v: NULL}, {v: NULL}, {v:NULL},},
  {"LCD_M/clear",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {v: NULL}, {o: FS_Mclear}, {v:NULL},},
  {"LCD_M/home",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {v: NULL}, {o: FS_Mhome}, {v:NULL},},
  {"LCD_M/screen", 128, NULL, ft_ascii, fc_stable, {v: NULL}, {o: FS_Mscreen}, {v:NULL},},
  {"LCD_M/message", 128, NULL, ft_ascii, fc_stable, {v: NULL}, {o: FS_Mmessage}, {v:NULL},},
  {"LCD_H",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {v: NULL}, {v: NULL}, {v:NULL},},
  {"LCD_H/clear",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {v: NULL}, {o: FS_Hclear}, {v:NULL},},
  {"LCD_H/home",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {v: NULL}, {o: FS_Hhome}, {v:NULL},},
  {"LCD_H/screen", 128, NULL, ft_ascii, fc_stable, {v: NULL}, {o: FS_Hscreen}, {v:NULL},},
  {"LCD_H/message", 128, NULL, ft_ascii, fc_stable, {v: NULL}, {o: FS_Hmessage}, {v:NULL},},
};
