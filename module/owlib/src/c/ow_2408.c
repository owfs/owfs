...
struct filetype DS2408[] = {
  ...
  {"sensed",PROPERTY_LENGTH_BITFIELD, &A2408, ft_bitfield, fc_volatile, {o: FS_sense}, {o: NULL}, {v:NULL},},
  ...
  {"LCD_M",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {o: NULL}, {o: NULL}, {v:NULL},},
  {"LCD_M/clear",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: NULL}, {o: FS_Mclear}, {v:NULL},},
  {"LCD_M/home",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: NULL}, {o: FS_Mhome}, {v:NULL},},
  {"LCD_M/screen", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_Mscreen}, {v:NULL},},
  {"LCD_M/message", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_Mmessage}, {v:NULL},},
  {"LCD_H",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {o: NULL}, {o: NULL}, {v:NULL},},
  {"LCD_H/clear",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: NULL}, {o: FS_Hclear}, {v:NULL},},
  {"LCD_H/home",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: NULL}, {o: FS_Hhome}, {v:NULL},},
  {"LCD_H/screen", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_Hscreen}, {v:NULL},},
  {"LCD_H/message", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_Hmessage}, {v:NULL},},
};
