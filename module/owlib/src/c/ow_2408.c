...
struct filetype DS2408[] = {
  ...
  {"PIO", 1, &A2408, ft_bitfield, fc_stable, {o: FS_r_pio}, {o: FS_w_pio}, {v:NULL},},
  {"sensed", 1, &A2408, ft_bitfield, fc_volatile, {o: FS_sense}, {v: NULL}, {v:NULL},},
  {"latch", 1, &A2408, ft_bitfield, fc_volatile, {o: FS_r_latch}, {o: FS_w_latch}, {v:NULL},},
  {"strobe", 1, NULL, ft_yesno, fc_stable, {o: FS_r_strobe}, {o: FS_w_strobe}, {v:NULL},},
  {"set_alarm", 9, NULL, ft_unsigned, fc_stable, {o: FS_r_s_alarm}, {o: FS_w_s_alarm}, {v:NULL},},
  {"por", 1, NULL, ft_yesno, fc_stable, {o: FS_r_por}, {o: FS_w_por}, {v:NULL},},
  {"LCD_M", 0, NULL, ft_subdir, fc_stable, {v: NULL}, {v: NULL}, {v:NULL},},
  {"LCD_M/clear", 1, NULL, ft_yesno, fc_stable, {v: NULL}, {o: FS_Mclear}, {v:NULL},},
  {"LCD_M/home", 1, NULL, ft_yesno, fc_stable, {v: NULL}, {o: FS_Mhome}, {v:NULL},},
  ...
  {"LCD_H/clear", 1, NULL, ft_yesno, fc_stable, {v: NULL}, {o: FS_Hclear}, {v:NULL},},
  {"LCD_H/home", 1, NULL, ft_yesno, fc_stable, {v: NULL}, {o: FS_Hhome}, {v:NULL},},
