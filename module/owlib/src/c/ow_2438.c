...
struct filetype DS2437[] = {
  ...
  {"VDD",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_volts}, {o: NULL}, {i:1},},
  {"VAD",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_volts}, {o: NULL}, {i:0},},
  {"temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_temp}, {o: NULL}, {v:NULL},},
  {"vis",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_Current}, {o: NULL}, {v:NULL},},
  {"Ienable",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_r_Ienable}, {o: FS_w_Ienable}, {v:NULL},},
  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter}, {o: FS_w_counter}, {s:0x08},},
  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second, {o: FS_r_date}, {o: FS_w_date}, {s:0x08},},
  {"disconnect",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {o: NULL}, {o: NULL}, {v:NULL},},
  {"disconnect/udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_counter}, {o: FS_w_counter}, {s:0x10},},
  {"disconnect/date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_volatile, {o: FS_r_date}, {o: FS_w_date}, {s:0x10},},
  {"endcharge",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {o: NULL}, {o: NULL}, {v:NULL},},
  {"endcharge/udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_counter}, {o: FS_w_counter}, {s:0x14},},
  {"endcharge/date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_volatile, {o: FS_r_date}, {o: FS_w_date}, {s:0x14},},
};
...
struct filetype DS2438[] = {
  ...
  {"VDD",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_volts}, {v: NULL}, {i:1},},
  {"VAD",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_volts}, {v: NULL}, {i:0},},
  {"temperature",PROPERTY_LENGTH_TEMP, NULL, ft_temperature, fc_volatile, {o: FS_temp}, {v: NULL}, {v:NULL},},
  {"humidity",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_Humid}, {v: NULL}, {v:NULL},},
  {"vis",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_Current}, {v: NULL}, {v:NULL},},
  {"Ienable",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_r_Ienable}, {o: FS_w_Ienable}, {v:NULL},},
  {"offset",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_r_Offset}, {o: FS_w_Offset}, {v:NULL},},
  {"udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_second, {o: FS_r_counter}, {o: FS_w_counter}, {s:0x08},},
  {"date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_second, {o: FS_r_date}, {o: FS_w_date}, {s:0x08},},
  {"disconnect",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"disconnect/udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_counter}, {o: FS_w_counter}, {s:0x10},},
  {"disconnect/date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_volatile, {o: FS_r_date}, {o: FS_w_date}, {s:0x10},},
  {"endcharge",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"endcharge/udate",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_counter}, {o: FS_w_counter}, {s:0x14},},
  {"endcharge/date",PROPERTY_LENGTH_DATE, NULL, ft_date, fc_volatile, {o: FS_r_date}, {o: FS_w_date}, {s:0x14},},
  {"HTM1735",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"HTM1735/humidity",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_Humid_1735}, {v: NULL}, {v:NULL},},
  {"HIH4000",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
  {"HIH4000/humidity",PROPERTY_LENGTH_FLOAT, NULL, ft_float, fc_volatile, {o: FS_Humid_4000}, {v: NULL}, {v:NULL},},
  {"MultiSensor",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_volatile, {v: NULL}, {v: NULL}, {v:NULL},},
