...
struct filetype DS1977[] = {
  ...
  {"pages",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {v: NULL}, {v: NULL}, {v:NULL},},
  {"pages/page", 64, &A1977, ft_binary, fc_stable, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
  {"set_password",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {v: NULL}, {v: NULL}, {v:NULL},},
  ...
  {"set_number",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {v: NULL}, {v: NULL}, {v:NULL},},
  ...
  {"version",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_ver}, {v: NULL}, {v:NULL},},
#if OW_CACHE
  {"use_password",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {v: NULL}, {v: NULL}, {v:NULL},},
  ...
  {"use_number",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {v: NULL}, {v: NULL}, {v:NULL},},
