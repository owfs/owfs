...
struct filetype DS1977[] = {
  ...
  {"pages",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {o: NULL}, {o: NULL}, {v:NULL},},
  {"pages/page", 64, &A1977, ft_binary, fc_stable, {o: FS_r_page}, {o: FS_w_page}, {v:NULL},},
  {"set_password",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {o: NULL}, {o: NULL}, {v:NULL},},
  {"set_password/read", 8, NULL, ft_binary, fc_stable, {o: NULL}, {o: FS_set}, {i:0},},
  {"set_password/full", 8, NULL, ft_binary, fc_stable, {o: NULL}, {o: FS_set}, {i:8},},
  {"set_password/enabled",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_pwd}, {o: FS_w_pwd}, {v:NULL},},
  {"set_number",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {o: NULL}, {o: NULL}, {v:NULL},},
  {"set_number/read", 47, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_nset}, {i:0},},
  {"set_number/full", 47, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_nset}, {i:8},},
  {"version",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_ver}, {o: NULL}, {v:NULL},},
#if OW_CACHE
  {"use_password",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {o: NULL}, {o: NULL}, {v:NULL},},
  {"use_password/read", 8, NULL, ft_binary, fc_stable, {o: NULL}, {o: FS_use}, {i:0},},
  {"use_password/full", 8, NULL, ft_binary, fc_stable, {o: NULL}, {o: FS_use}, {i:8},},
  {"use_number",PROPERTY_LENGTH_SUBDIR, NULL, ft_subdir, fc_stable, {o: NULL}, {o: NULL}, {v:NULL},},
  {"use_number/read", 47, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_nuse}, {i:0},},
  {"use_number/full", 47, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_nuse}, {i:8},},
#endif							/*OW_CACHE */
};
