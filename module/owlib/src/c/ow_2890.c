...
struct filetype DS2890[] = {
	F_STANDARD,
  {"chargepump",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_cp}, {o:FS_w_cp}, {v:NULL},},  {"chargepump",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_cp}, {o:FS_w_cp}, {v:NULL},},  {"chargepump",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:FS_r_cp}, {o:FS_w_cp}, {v:NULL},},  {"chargepump",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: FS_r_cp}, {o: FS_w_cp}, {v:NULL},},
  {"wiper",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_r_wiper}, {o:FS_w_wiper}, {v:NULL},},  {"wiper",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_r_wiper}, {o:FS_w_wiper}, {v:NULL},},  {"wiper",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable,  {o:FS_r_wiper}, {o:FS_w_wiper}, {v:NULL},},  {"wiper",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_stable, {o: FS_r_wiper}, {o: FS_w_wiper}, {v:NULL},},
};
