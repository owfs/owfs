...
struct filetype LCD[] = {
	F_STANDARD,
  {"LCDon",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: NULL}, {o: FS_w_on}, {v:NULL},},
  {"backlight",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: NULL}, {o: FS_w_backlight}, {v:NULL},},
  {"version", 16, NULL, ft_ascii, fc_stable, {o: FS_r_version}, {o: NULL}, {v:NULL},},
  ...
  {"counters",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile, {o: FS_r_counters}, {o: NULL}, {v:NULL},},
#if OW_CACHE
  ...
  {"screen16", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_screenX}, {i:16},},
  {"screen20", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_screenX}, {i:20},},
  {"screen40", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_screenX}, {i:40},},
  {"line16", 16, &ALCD_L16, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_lineX}, {i:16},},
  {"line20", 20, &ALCD_L20, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_lineX}, {i:20},},
  {"line40", 40, &ALCD_L40, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_lineX}, {i:40},},
};
