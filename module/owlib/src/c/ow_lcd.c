...
struct filetype LCD[] = {
	F_STANDARD,
  {"LCDon",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_on}, {v:NULL},},  {"LCDon",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_on}, {v:NULL},},  {"LCDon",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_on}, {v:NULL},},  {"LCDon",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: NULL}, {o: FS_w_on}, {v:NULL},},
  {"backlight",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_backlight}, {v:NULL},},  {"backlight",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_backlight}, {v:NULL},},  {"backlight",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_backlight}, {v:NULL},},  {"backlight",PROPERTY_LENGTH_YESNO, NULL, ft_yesno, fc_stable, {o: NULL}, {o: FS_w_backlight}, {v:NULL},},
  {"version", 16, NULL, ft_ascii, fc_stable,  {o:FS_r_version}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"version", 16, NULL, ft_ascii, fc_stable,  {o:FS_r_version}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"version", 16, NULL, ft_ascii, fc_stable,  {o:FS_r_version}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"version", 16, NULL, ft_ascii, fc_stable, {o: FS_r_version}, {o: NULL}, {v:NULL},},
  {"gpio",PROPERTY_LENGTH_BITFIELD, &ALCD, ft_bitfield, fc_volatile,  {o:FS_r_gpio}, {o:FS_w_gpio}, {v:NULL},},  {"gpio",PROPERTY_LENGTH_BITFIELD, &ALCD, ft_bitfield, fc_volatile,  {o:FS_r_gpio}, {o:FS_w_gpio}, {v:NULL},},  {"gpio",PROPERTY_LENGTH_BITFIELD, &ALCD, ft_bitfield, fc_volatile,  {o:FS_r_gpio}, {o:FS_w_gpio}, {v:NULL},},  {"gpio",PROPERTY_LENGTH_BITFIELD, &ALCD, ft_bitfield, fc_volatile, {o: FS_r_gpio}, {o: FS_w_gpio}, {v:NULL},},
  {"register",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_register}, {o:FS_w_register}, {v:NULL},},  {"register",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_register}, {o:FS_w_register}, {v:NULL},},  {"register",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_register}, {o:FS_w_register}, {v:NULL},},  {"register",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_register}, {o: FS_w_register}, {v:NULL},},
  {"data",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_data}, {o:FS_w_data}, {v:NULL},},  {"data",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_data}, {o:FS_w_data}, {v:NULL},},  {"data",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile,  {o:FS_r_data}, {o:FS_w_data}, {v:NULL},},  {"data",PROPERTY_LENGTH_UNSIGNED, NULL, ft_unsigned, fc_volatile, {o: FS_r_data}, {o: FS_w_data}, {v:NULL},},
  {"counters",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile,  {o:FS_r_counters}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"counters",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile,  {o:FS_r_counters}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"counters",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile,  {o:FS_r_counters}, {o:NO_WRITE_FUNCTION}, {v:NULL},},  {"counters",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile, {o: FS_r_counters}, {o: NULL}, {v:NULL},},
#if OW_CACHE
  {"cumulative",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile,  {o:FS_r_cum}, {o:FS_w_cum}, {v:NULL},},  {"cumulative",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile,  {o:FS_r_cum}, {o:FS_w_cum}, {v:NULL},},  {"cumulative",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile,  {o:FS_r_cum}, {o:FS_w_cum}, {v:NULL},},  {"cumulative",PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile, {o: FS_r_cum}, {o: FS_w_cum}, {v:NULL},},
#endif							/*OW_CACHE */
  {"memory", 112, NULL, ft_binary, fc_stable,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},  {"memory", 112, NULL, ft_binary, fc_stable,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},  {"memory", 112, NULL, ft_binary, fc_stable,  {o:FS_r_memory}, {o:FS_w_memory}, {v:NULL},},  {"memory", 112, NULL, ft_binary, fc_stable, {o: FS_r_memory}, {o: FS_w_memory}, {v:NULL},},
  {"screen16", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:16},},  {"screen16", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:16},},  {"screen16", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:16},},  {"screen16", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_screenX}, {i:16},},
  {"screen20", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:20},},  {"screen20", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:20},},  {"screen20", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:20},},  {"screen20", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_screenX}, {i:20},},
  {"screen40", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:40},},  {"screen40", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:40},},  {"screen40", 128, NULL, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_screenX}, {i:40},},  {"screen40", 128, NULL, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_screenX}, {i:40},},
  {"line16", 16, &ALCD_L16, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:16},},  {"line16", 16, &ALCD_L16, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:16},},  {"line16", 16, &ALCD_L16, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:16},},  {"line16", 16, &ALCD_L16, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_lineX}, {i:16},},
  {"line20", 20, &ALCD_L20, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:20},},  {"line20", 20, &ALCD_L20, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:20},},  {"line20", 20, &ALCD_L20, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:20},},  {"line20", 20, &ALCD_L20, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_lineX}, {i:20},},
  {"line40", 40, &ALCD_L40, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:40},},  {"line40", 40, &ALCD_L40, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:40},},  {"line40", 40, &ALCD_L40, ft_ascii, fc_stable,  {o:NO_READ_FUNCTION}, {o:FS_w_lineX}, {i:40},},  {"line40", 40, &ALCD_L40, ft_ascii, fc_stable, {o: NULL}, {o: FS_w_lineX}, {i:40},},
};
