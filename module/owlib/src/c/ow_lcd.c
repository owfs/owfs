  ...
  {"backlight", PROPERTY_LENGTH_YESNO, NON_AGGREGATE, ft_yesno, fc_stable,
	 NO_READ_FUNCTION, FS_simple_command,
	  {u:PACK_ON_OFF(_LCD_COMMAND_BACKLIGHT_ON,
				 ...
				 {"version", _LCD_PAGE_SIZE, NON_AGGREGATE, ft_ascii, fc_stable, FS_r_version, NO_WRITE_FUNCTION, NO_PROPERTY_DATA,},
  {"gpio", PROPERTY_LENGTH_BITFIELD, &ALCD, ft_bitfield, fc_volatile, FS_r_gpio, FS_w_gpio, NO_PROPERTY_DATA,},
  {"register", PROPERTY_LENGTH_UNSIGNED, NON_AGGREGATE, ft_unsigned, fc_volatile, FS_r_register, FS_w_register, NO_PROPERTY_DATA,},
  {"data", PROPERTY_LENGTH_UNSIGNED, NON_AGGREGATE, ft_unsigned, fc_volatile, FS_r_data, FS_w_data, NO_PROPERTY_DATA,},
  {"counters", PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile, FS_r_counters, NO_WRITE_FUNCTION, NO_PROPERTY_DATA,},
#if OW_CACHE
  {"cumulative", PROPERTY_LENGTH_UNSIGNED, &ALCD, ft_unsigned, fc_volatile, FS_r_cum, FS_w_cum, NO_PROPERTY_DATA,},
#endif							/*OW_CACHE */
{"memory", 112, NON_AGGREGATE, ft_binary, fc_stable, FS_r_memory, FS_w_memory, NO_PROPERTY_DATA,},
