...
#define F_address  \
    {"address"   ,  PROPERTY_LENGTH_ADDRESS,  NULL, ft_ascii , fc_static  , FS_address  , NO_WRITE_FUNCTION, {v:NULL}, }
#define F_r_address  \
    {"r_address" ,  PROPERTY_LENGTH_ADDRESS,  NULL, ft_ascii , fc_static  , FS_r_address, NO_WRITE_FUNCTION, {v:NULL}, }
#define F_crc8     \
...
#define F_present  \
    {"present"   ,   PROPERTY_LENGTH_YESNO,  NULL, ft_yesno , fc_volatile, FS_present  , NO_WRITE_FUNCTION, {v:NULL}, }
#define F_type     \
    {"type"      ,  PROPERTY_LENGTH_TYPE,  NULL, ft_vascii, fc_static  , FS_type     , NO_WRITE_FUNCTION, {v:NULL}, }
#define F_alias     \
    {"alias"      ,PROPERTY_LENGTH_ALIAS,  NULL, ft_vascii, fc_alias   , FS_alias    , NO_WRITE_FUNCTION, {v:NULL}, }
#define F_locator  \
    {"locator"   ,  PROPERTY_LENGTH_ADDRESS,  NULL, ft_ascii , fc_directory,FS_locator  , NO_WRITE_FUNCTION, {v:NULL}, }
#define F_r_locator\
