...
#define SWIG_init    boot_OW

#define SWIG_name   "OWc::boot_OW"
#define SWIG_prefix "OWc::"
...
int init(char const *);
char *get(char const *);
int put(char const *,char const *);
void finish(void);
void set_error_print(int);
int get_error_print(void);
void set_error_level(int);
int get_error_level(void);
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_OW_var::
class _wrap_OW_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_put) {
    {
        ...
        if ((items < 2) || (items > 2)) {
            SWIG_croak("Usage: put(path,value);");
        }
        if (!SvOK((SV*) ST(0))) arg1 = 0;
        else arg1 = (char *) SvPV(ST(0), PL_na);
...
XS(_wrap_set_error_print) {
    {
        ...
        if ((items < 1) || (items > 1)) {
            SWIG_croak("Usage: set_error_print(int);");
        }
        arg1 = (int) SvIV(ST(0));
...
XS(_wrap_get_error_print) {
    {
        ...
        if ((items < 0) || (items > 0)) {
            SWIG_croak("Usage: get_error_print();");
        }
...
XS(_wrap_set_error_level) {
    {
        ...
        if ((items < 1) || (items > 1)) {
            SWIG_croak("Usage: set_error_level(int);");
        }
        arg1 = (int) SvIV(ST(0));
...
XS(_wrap_get_error_level) {
    {
        ...
        if ((items < 0) || (items > 0)) {
            SWIG_croak("Usage: get_error_level();");
        }
...
{"OWc::version", _wrap_version},
{"OWc::init", _wrap_init},
{"OWc::get", _wrap_get},
{"OWc::put", _wrap_put},
{"OWc::finish", _wrap_finish},
{"OWc::set_error_print", _wrap_set_error_print},
{"OWc::get_error_print", _wrap_get_error_print},
{"OWc::set_error_level", _wrap_set_error_level},
{"OWc::get_error_level", _wrap_get_error_level},
{0,0}
};
